...
aa_institution <- ggplot(mean_data, aes(x = institution_size_category, y = mean_african_american)) +
...
aa_women <- ggplot(mean_data, aes(x = as.factor(quantiles_women), y = mean_african_american)) +
  geom_boxplot(alpha = 0.25) +
...
aa_admissions <- ggplot(mean_data, aes(x = as.factor(quantiles_admission), y = mean_african_american)) +
  geom_boxplot(alpha = 0.25) +
...
aa_urban <- ggplot(mean_data, aes(x = as.factor(degree_of_urbanization_urban_centric_locale), y = mean_african_american)) +
  geom_boxplot(alpha = 0.25) +
...
dwplot(model_african_american) %>%
  ...
  theme_classic() +
  ggtitle("Correlation between Independent Variables and African American Student Population") +
...
dwplot(model_african_american_2, show_intercept = TRUE) %>%
  ...
  theme_classic() +
  ggtitle("Correlation between Locale and African American Student Population") +
  theme(legend.position = "none")




aa_boxplots <- (aa_institution / aa_women / aa_admissions)
aa_boxplots
