...
In addition to these data sets, I have collected census race data from (census.gov) in order to compare the mean racial diversity of a set of institutions in a particular state to the general degree of diversity in that state.
